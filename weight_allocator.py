...
class weight_allocator:
    ...
    def linear_weight(self):
        ...
        1. put more weight on the style factors 
        2. If the short signal is really strong, short
        otherwise: 
            3. clip the style factor at [0,0.2]
            4. clip the industry factor at [0,0.03]
            5. clip the market factor at [0,0.2]
        '''
        ...
        weight = weight.div(weight.apply(abs).sum(axis=1), axis=0)
        return (weight)
